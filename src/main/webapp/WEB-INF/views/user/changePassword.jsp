            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        ...
                        <form " action="${base }/admin/changePassword" class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                            
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Mật khẩu Hiện tại</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="oldPassword" type="password" name="oldPassword" placeholder="Mật khẩu hiện tại">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Mật khẩu</label>
                                <div class="col-sm-10">
                                    <input class="form-control" id="newPassword" type="password" name="newPassword" placeholder="Mật khẩu">
                                </div>
                            </div>
                            <div class="form-group row">
